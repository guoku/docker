...
from entity_spider.config import storage as storage_config
from entity_spider.core.file import ContentFile
from entity_spider.core.storage.storage import FileSystemStorage
from entity_spider.core .storage.storage import MogileFSStorage

if getattr(storage_config, 'LOCAL_FILE_STORAGE') == True:
    image_path = getattr(storage_config, 'LOCAL_IMAGE_PATH', 'images/')
else :
    image_path = getattr(storage_config, 'MOGILEFS_MEDIA_URL', 'images/')

image_host = getattr(storage_config, 'IMAGE_HOST', None)


def get_storage_class():
    if storage_config.LOCAL_FILE_STORAGE:
